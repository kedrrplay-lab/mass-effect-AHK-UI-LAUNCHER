...
OLD DISCRIPTION IM LAZY TO UPDATE HIM
 ...
 Важное примечание по переключению языка
    ...
    Если у вас не переключается язык на русский:
        ...
        Сначала включите английский язык

        Затем снова выберите русский
...
What's new?
    ...
    Auto‑creation of config file (not 100% sure it works… seems to work though)

Installation

    Place the Game folder inside the game root folder:
    Mass Effect Legendary Edition
...
Если хотите, могу адаптировать этот текст под конкретный формат (например, README.md для GitHub, стикер для Telegram, или просто в виде скриншота).
